...
export interface SimulationConfig {
  ...
  panic_separation_weight?: number;
  panic_burst_factor?: number;
  panic_burst_ticks?: number;
  ...
  predator_preferred_distance?: number;
  predator_lunge_factor?: number;
  predator_lunge_ticks?: number;
  predator_cluster_min_size?: number;
  predator_levy_min_steps?: number;
  predator_levy_max_steps?: number;
  predator_levy_mu?: number;
  predator_max_turn_rate?: number;
  predator_wall_repulsion_radius?: number;
  predator_wall_repulsion_weight?: number;
