...
export const ASSET_MANIFEST: AssetManifest = {
  ...
  agents: {
    scout: {
      agentType: "scout",
      gltfPath: "/assets/gltf/scout.gltf",
    ...
    collector: {
      agentType: "collector",
      gltfPath: "/assets/gltf/collector.gltf",
    ...
    marine_life: {
      ...
      gltfPath: "/assets/gltf/marine-life.gltf",
    ...
    trash: {
      agentType: "trash",
      gltfPath: "/assets/gltf/trash.gltf",
    ...
    predator: {
      agentType: "predator",
      gltfPath: "/assets/gltf/predator.gltf",
  ...
  stage: [
    ...
    },
    {
      id: "base-platform",
      type: "gltf",
      path: "/assets/gltf/base-platform.gltf",
      x: 480,
      y: 604,
      width: 180,
      height: 86,
